...
public abstract class ExcelReader extends DefaultHandler {
	 ...
	 * @throws Exception
	 */
	public void process(InputStream in, int sheetId) throws Exception {
	...
	public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
		...
		/*
		 * // 当元素为t时 忽略空的单元格 if ("t".equals(name)) { isTElement = true; } else {
		 * isTElement = false; }
		 */

		isTElement = true;// 不忽略空的单元格
	...
	public void endElement(String uri, String localName, String name) throws SAXException {
		...
		if (isTElement) {
			...
			if (name.equals("row")) {
				...
				getLastRows(sheetIndex + 1, curRow - 1);
				curCol = 0;
			}
		}
	 ...
	 * @param rowList
	 */
	public abstract void getLastRows(int sheetIndex, int curRow);
	...
	public static void main(String[] args) throws Exception {
		...
		ExcelReader reader = new ExcelReader() {
			...
			public void getLastRows(int sheetIndex, int curRow) {
