...
/*    public static double pi = 3.1415926535897932384626;
    ...
    public static void main(String[] args) {
    	//double[] result = gcj02_To_Gps84(25.876458,119.591059);
    	//System.out.println(result[0]+" "+result[1]);
    	//double[] result =  gps84_To_Gcj02(25.876458,119.587464);
    	//System.out.println(result[1]+","+result[0]);
    /*	double[] result = gcj02_To_Bd09(25.03554,118.80924);
    	System.out.println(result[1]+","+result[0]);*/
    	double[] result = gps84_To_bd09(32.04273,116.7852);
    	System.out.println(result[1]+","+result[0]);
