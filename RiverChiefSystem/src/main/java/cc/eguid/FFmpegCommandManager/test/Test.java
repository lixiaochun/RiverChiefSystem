...
public class Test {
	...
	public static void test4() throws InterruptedException {
		...
		// 默认方式发布任务
		manager.start("test1",
				"ffmpeg -rtsp_transport tcp -re -i rtsp://liantong:lt123456@183.250.240.180:15003/cam/realmonitor?channel=5&subtype=1 -codec:v libx264 -codec:a libfaac -map 0 -f hls  -hls_list_size 6 -hls_wrap 10 -hls_time 10 d:/develop/tomcat/apache-tomcat-8.5.23-quanzhou/apache-tomcat-8.5.23/webapps/aa/playlist.m3u8");
